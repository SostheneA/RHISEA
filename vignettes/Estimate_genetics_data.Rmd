...
```{r assignment_tests_naives_Bayes, fig.alt = "Assignment using genetic data and naive Bayes"}
...
```{r assignment_tests_decision_tree, fig.alt = "Assignment using integrated data and decision tree"}
...
unlink("Result-folder2", recursive = TRUE, force = TRUE)
unlink("Result-folder3", recursive = TRUE, force = TRUE)
unlink("Result-folder4", recursive = TRUE, force = TRUE)
unlink("rf_results_4Mod", recursive = TRUE, force = TRUE)
unlink(c("*.rda", "*.std", "*.mix", "*.ctr", "*.out", "*.xlsx", "fort.*"), force = TRUE)
```
