---
title: "Using-run_hisea_estimates-with-Custom_Classification_Models"
output: rmarkdown::html_vignette
vignette: >
  %\\VignetteIndexEntry{Using-run_hisea_estimates-with-Custom_Classification_Models}
...
```{r lda, fig.alt="LDA classification results for mixed stock analysis"}
...
```{r rf, fig.alt="Random Forest classification results for mixed stock analysis"}
...
```{r ctree, fig.alt="CTREE classification results for mixed stock analysis"}
library(party)
