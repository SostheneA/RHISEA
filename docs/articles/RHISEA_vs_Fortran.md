...
- Run HISEA estimators in R (`run_hisea_all` with LDA and LDA_MASS
  methods)
- Run the Fortran executable (assumed available as `hisea.exe`) for
  comparison
- Aggregate and visualize estimator results (R vs Fortran)
- Export results to Excel
- Perform simple diagnostics to detect large discrepancies between
  methods
...
We simulate 50 datasets, run R estimators and Fortran executable, then
store results.
...
![Comparison of R vs Fortran estimates for each
estimator](figure/plot-estimator-RvsFortran-1.png)![Comparison of R vs
Fortran estimates for each
estimator](figure/plot-estimator-RvsFortran-2.png)![Comparison of R vs
Fortran estimates for each
estimator](figure/plot-estimator-RvsFortran-3.png)![Comparison of R vs
Fortran estimates for each
estimator](figure/plot-estimator-RvsFortran-4.png)![Comparison of R vs
Fortran estimates for each
estimator](figure/plot-estimator-RvsFortran-5.png)
...
![Comparison of R_MASS vs Fortran estimates for each
estimator](figure/plot-estimator-RMASSvsFortran-1.png)![Comparison of
R_MASS vs Fortran estimates for each
estimator](figure/plot-estimator-RMASSvsFortran-2.png)![Comparison of
R_MASS vs Fortran estimates for each
estimator](figure/plot-estimator-RMASSvsFortran-3.png)![Comparison of
R_MASS vs Fortran estimates for each
estimator](figure/plot-estimator-RMASSvsFortran-4.png)![Comparison of
R_MASS vs Fortran estimates for each
estimator](figure/plot-estimator-RMASSvsFortran-5.png)
...
![Boxplot comparing all methods across
simulations](figure/boxplot-all-methods-1.png)

Boxplot comparing all methods across simulations
...
This vignette provides a full workflow to simulate, run, compare and
diagnose the HISEA estimation methods in R versus the original Fortran
implementation. All results and plots help verify the consistency and
quality of the R implementation, and the diagnostics alert when large
discrepancies occur.
