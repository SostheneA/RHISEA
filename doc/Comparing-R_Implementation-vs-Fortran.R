...
## ----plot-estimator-RvsFortran, fig.cap="Comparison of R vs Fortran estimates for each estimator"----
...
## ----plot-estimator-RMASSvsFortran, fig.cap="Comparison of R_MASS vs Fortran estimates for each estimator"----
...
## ----boxplot-all-methods, fig.cap="Boxplot comparing all methods across simulations"----
